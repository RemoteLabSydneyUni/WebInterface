...
SimpleCounterControl.prototype.setup = function() {
        ...
        this.widgets.push(new DataValWidget(this.$container, 'Sensors', 'info', 'sensor 1=', 'sensor[0]'));
		...
		countincwidget = new SliderWidget(this.$container, 'Increment', 'increment', 'increment', 'setCounterInc');
...
CameraWidget.prototype.consume = function(data) {
	...
	*/
	...
	ctx.fillStyle = "rgba(" + colourR + ", 0, " + colourB + ", 1)";
	...
	// for(var i = 1; i <= 11; i++){
		// ctx.fillRect(this.videoWidth*(0.25+0.5/10*(i-1))-10,this.videoHeight*0.35-10, ctx.measureText(i).width,12);
	// }
	// ctx.font = "20px Georgia";
		// ctx.fillStyle=fillStyle ;
	// for(var i = 1; i <= 11; i++){
		// ctx.fillText(i, this.videoWidth*(0.25+0.5/10*(i-1))-10,this.videoHeight*0.35);
	// }	
	ctx.strokeStyle="#ffffff";
	ctx.font = "24px Georgia";
	ctx.fillStyle="#ffffff";	
	for(var i = 1; i <= 11; i++){
		var j = 0;
			if((i%2)==0)
				...
				j=this.videoHeight*0.3+11;
		ctx.fillRect(this.videoWidth*(0.25+0.5/10*(i-1))-10,this.videoHeight*0.35-10+j, ctx.measureText(i).width,12);
	}
	ctx.font = "20px Georgia";
		ctx.fillStyle=fillStyle ;
	for(var i = 1; i <= 11; i++){
		...
		ctx.fillText(i, this.videoWidth*(0.25+0.5/10*(i-1))-10,this.videoHeight*0.35+j);
	}	
