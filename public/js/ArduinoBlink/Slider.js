...
LabVIEWControl.prototype.setup = function() {
        /* Add camera to page. */
        this.widgets.push(new CameraWidget(this.$container, 'Camera', 'http://129.78.10.57/videostream.cgi?user=admin&pwd=passwd&resolution=32&rate=0', ''));
 
		delay = new SliderWidget(this.$container, "Blink Delay", "blinkdelay", "delay", "setDelay") 
		delay.setRange(2, 10);
		delay.setOrientation(false);
		delay.setLabels("Delay", "s");
		this.widgets.push(delay);
...
LabVIEWControl.prototype.acquireLoop = function() {
        ...
        $.ajax({
                url: "/primitive/mapjson/pc/" + this.controller + "Controller/pa/dataAndGraph",
                data: {
                    period: this.period,
...
ButtonWidget.prototype.init = function() {
	...
	this.$widget.find(".reset-button").click(function() { $("#res-to-change").html("Reset"); }); 
